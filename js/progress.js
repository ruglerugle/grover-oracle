...
(function (global) {
  ...
  var STORAGE_KEY = "groverOracleQuestProgress_v1";
  ...
  var STAGES = [
    { n: 1, file: "stage1.html", title: "一致判定は回路になる", sub: "比較リストは要らない" },
    { n: 2, file: "stage2.html", title: "位相に目印を付ける", sub: "Xゲートと多重制御Z" },
    { n: 3, file: "stage3.html", title: "重ね合わせを1回で", sub: "線形性という仕分け係" },
    { n: 4, file: "stage4.html", title: "128ビットの照合", sub: "ANDの鎖と逆計算" },
    { n: 5, file: "stage5.html", title: "AES鍵探索の全体像", sub: "レジスタは1本" },
    { n: 6, file: "stage6.html", title: "それでも2⁶⁴回", sub: "誠実な結論" }
  ];
